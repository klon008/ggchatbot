...
# Среди исходов без негатива (взаимоисключающие):
MISS_CHANCE = 0.20  # сход: клёв был, рыба сорвалась
TRASH_CHANCE = 0.18  # мусор
# рыба = 1 - MISS_CHANCE - TRASH_CHANCE = 0.62

# Вид: (вес дропа, w_min, w_max, base_price)
FISH_SPECIES: dict[str, tuple[int, float, float, int]] = {
    "Карась": (28, 0.15, 0.80, 10),
    "Плотва": (22, 0.10, 0.55, 12),
    "Окунь": (18, 0.20, 1.20, 20),
    "Лещ": (12, 0.40, 2.00, 30),
    "Щука": (10, 0.80, 4.00, 45),
    "Сом": (6, 1.50, 8.00, 70),
    "Осётр": (4, 2.00, 12.00, 125),
}
