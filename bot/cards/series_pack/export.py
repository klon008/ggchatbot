...
from .models import PACK_VERSION, PackDraft, RARITIES
...
def build_zip(draft: PackDraft, out_dir: Path) -> Path:
    ...
    try:
        ...
        series_json = {
            ...
            "draw": {
                ...
                "rarity_weights": {
                    k: float(draw.rarity_weights.get(k, 0) or 0) for k in RARITIES
                },
